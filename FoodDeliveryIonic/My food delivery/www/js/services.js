...
.factory('recipeService',function($firebaseArray) {
	var fb = new Firebase('https://mfdelivery-64337.firebaseio.com/menu');
...
.factory('fireBaseData', function($firebase,$firebaseArray) {
	var ref = new Firebase("https://mfdelivery-64337.firebaseio.com/"),
    refCart = new Firebase("https://mfdelivery-64337.firebaseio.com/cart"),
    refUser = new Firebase("https://mfdelivery-64337.firebaseio.com/users"),
    refCategory = new Firebase("https://mfdelivery-64337.firebaseio.com/category"),
    refOrder = new Firebase("https://mfdelivery-64337.firebaseio.com/orders"),
    refFeatured = new Firebase("https://mfdelivery-64337.firebaseio.com/featured"),
    refMenu = new Firebase("https://mfdelivery-64337.firebaseio.com/menu"),
    refSlider = new Firebase("https://mfdelivery-64337.firebaseio.com/slider")
    ;
