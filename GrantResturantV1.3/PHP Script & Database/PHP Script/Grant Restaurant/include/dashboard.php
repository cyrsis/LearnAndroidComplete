                    ...
                    <div class="widget-content">
                        <div class="stat">
                            <div class="stat-header">
                                <a href="homedelivery.php" class="btn btn-small btn-info" title="Order for Home Delivery Service"> <?php echo _("Home Delivery Orders"); ?></a>
                        ...
                        <div class="stat">
                            <div class="stat-header">
                                <a href="dashboard.php" class="btn btn-small btn-primary" title="Today Request For Book Table "> <?php echo _("Request For Booktable"); ?></a>
                                <div class="stat-value">
                                    <b><?php echo $i; ?></b>
                                </div>
                            </div>
                            ...
                            while($data=mysqli_fetch_array($query1)) {
                                ...
                                if ($date == $dt) {
                                    ...
                                    if($_SESSION['demo'] == 1) {
                                        ...
                                        ?>
                                        <a onclick="deleteorder(<?php echo $data['id']; ?>)" class="btn btn-tertiary"
                                        ...
                                        <?php
                                                ...
                                                if ($data['confirm_order'] == 0) {
                                                    ?>
                                                    <a href="#confirm" onclick="demo(<?php echo $data['id']; ?>)"
                                                       data-toggle="modal" class="btn btn-success"
                                                       title="Delete Order"><?php echo _("Confirm"); ?></a>
                                                ...
                                                ?>
                                                <a onclick="demo(<?php echo $data['id']; ?>)" class="btn btn-tertiary"
                                                   title="Delete Order"><?php echo _("Delete"); ?></a>
                                                <?php
                                            }
                                        ?>
